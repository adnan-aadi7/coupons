...
export default function DashboardPage() {
  ...
  const handleSimulate = async (clickId: string) => {
    try {
      ...
      // RTK Query will automatically refetch 'User' tag and update balance
    } catch (err) {
  ...
  return (
    <main className="min-h-screen bg-obsidian text-white pb-24">
      <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-32 space-y-12">

    ...
    <section className="py-16 lg:py-24 bg-white border-t border-slate-100">
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 space-y-12">
        ...
        <div className="space-y-8">
          <SectionHeader 
            title={activeCategory === 'all' ? 'Trending Coupons' : `${activeCategory} Deals`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-12">
            {isLoading ? (
              ...
              deals.data.map((coupon: any, i: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-[80px] h-[80px] shrink-0 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-center overflow-hidden">
                      {coupon.brandLogo ? (
                        <img src={coupon.brandLogo} alt={coupon.store || coupon.brand} className="w-[48px] h-[48px] object-contain mix-blend-multiply group-hover:scale-110 transition-transform" />
                      ) : (

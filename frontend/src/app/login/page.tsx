...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-['Exo_2',sans-serif] flex overflow-hidden mt-10">
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center px-12 md:px-24 lg:px-32 py-20 relative">
        ...
        >
          <h1 className="text-[56px] font-semibold text-black mb-12">Welcome Back</h1>
          ...
          <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center gap-3">
              <input type="checkbox" id="remember" className="w-5 h-5 rounded border-slate-200 text-[#FF6A13] focus:ring-[#FF6A13]" />
          ...
          <div className="mt-8 text-center space-y-8">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="relative bg-white px-4 text-slate-400 text-sm font-medium">or</span>
            </div>
      ...
      {/* Right Side: Simplified Brand Panel */}

...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-['Exo_2',sans-serif] mt-10 flex overflow-hidden">
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center px-12 md:px-24 lg:px-32 py-20 relative">
        ...
        >
          <h1 className="text-[56px] font-semibold text-black mb-12">Create Account</h1>
